...
|--------|-----------|-----------|-------------|
| C<sub>L</sub> | 0.07% | 0.84% | 0.02% |
| C<sub>Dff</sub> | 0.08% | 0.78% | 0.00% |
| C<sub>m</sub> | 0.61% | 6.09%&dagger; | 0.16% |

**55/55 cases solved. 55/55 within 1% C<sub>L</sub> error.**

&dagger; **Important note on C<sub>m</sub> relative errors:** The maximum relative error now occurs in `supergee`, where the reference C<sub>m</sub> is only &minus;0.01013 and Julia computes &minus;0.01075 (absolute difference **0.00062**). Near-zero denominators can still inflate relative percentages, while absolute agreement remains tight across the full suite.
...
1. Academic and Research Purposes Only
This repository and its contents are provided strictly for academic research, educational purposes, and scientific reproducibility. The software, scripts, and algorithms contained herein are experimental and have not been developed, tested, or certified for commercial, industrial, clinical, or production environments.

2. No Warranties or Guarantees (Provided "AS IS")
The code is provided "AS IS", without warranty of any kind, express or implied. The authors and their affiliated institutions make no representations or warranties regarding the software's accuracy, reliability, completeness, or fitness for any particular purpose.

3. Limitation of Liability
Under no circumstances shall the authors, contributors, or affiliated academic institutions be held liable for any claim, damages, or other liability—whether in an action of contract, tort, or otherwise—arising from, out of, or in connection with the software or the use or other dealings in the software. This includes, but is not limited to, data loss, system malfunctions, or any direct or indirect consequences resulting from the application of this code.

4. User Responsibility
By downloading, cloning, or utilizing this repository, you assume all risks associated with its use. It is solely your responsibility to verify the accuracy of the code and any results generated by it before relying on them in your own research or publications.
